...
public class PipesGraphGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import pipesgraph.PipesGraph;");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("PipesGraph g = new PipesGraph();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("g.invoke();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    fsa.generateFile("main/Main.java", _builder);
    ...
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("public abstract class Component extends PipeStages implements Comparable<Component>{");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("protected int level = 0;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("protected String name;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("Runnable call;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("Runnable assign;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("protected PipesGraph graph;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public PipesGraph getPipesGraph(){return graph;};");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public void setPipesGraph(PipesGraph g){graph=g;};");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public int getLevel() {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("return level;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public void checkLevel(Component c){");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("if(level<c.getLevel())");
    _builder_1.newLine();
    _builder_1.append("\t\t\t");
    _builder_1.append("level = c.getLevel()+1;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public int compareTo(Component c) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("return Integer.compare(this.level, c.getLevel());");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public void invoke(){");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("assign.run();");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("call.run();");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public void setCall(Runnable r) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("call=r;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("public String getName(){return name;};");
    _builder_1.newLine();
    _builder_1.append("}");
    fsa.generateFile(_buildFileName, _builder_1);
    ...
    _builder_2.append("\t\t \t");
    _builder_2.newLine();
    _builder_2.append("public abstract class Source extends Component{");
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("}");
    _builder_2.newLine();
    fsa.generateFile(_buildFileName_1, _builder_2);
    ...
    _builder_3.newLine();
    _builder_3.newLine();
    _builder_3.append("public abstract class Filter extends Component{");
    _builder_3.newLine();
    _builder_3.newLine();
    _builder_3.append("}");
    _builder_3.newLine();
    fsa.generateFile(_buildFileName_2, _builder_3);
    ...
    _builder_4.append("\t\t \t");
    _builder_4.newLine();
    _builder_4.append("public abstract class Sink extends Component{");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("}");
    fsa.generateFile(_buildFileName_3, _builder_4);
    ...
    for (final Source source : _filter) {
      String _buildFileName_4 = this.buildFileName(source.getName());
      ...
      _builder_5.append(" extends Source{");
      _builder_5.newLineIfNotEmpty();
      {
      ...
      _builder_5.newLine();
      _builder_5.append("} ");
      fsa.generateFile(_buildFileName_4, _builder_5);
    }
    ...
    for (final Filter filter : _filter_5) {
      ...
      _builder_6.append(_substring_3, "\t");
      _builder_6.append("};");
      _builder_6.newLineIfNotEmpty();
      _builder_6.append("\t");
      _builder_6.append("break;}");
      ...
      _builder_6.newLine();
      _builder_6.append("}");
      fsa.generateFile(_buildFileName_5, _builder_6);
    }
    ...
    for (final Sink sink : _filter_10) {
      {
        ...
        _builder_7.append(" extends Sink{");
        _builder_7.newLineIfNotEmpty();
        _builder_7.newLine();
        {
          EList<Port> _inPorts_2 = sink.getInPorts();
              ...
              if (_equals_6) {
                {
                  ...
                  if (_tripleNotEquals_3) {
                    ...
                    _builder_7.append(_substring_4, "\t");
                    _builder_7.append("};");
                    _builder_7.newLineIfNotEmpty();
                    _builder_7.append("\t");
        ...
        _builder_7.append(_substring_5, "\t");
        _builder_7.append("};");
        _builder_7.newLineIfNotEmpty();
        _builder_7.append("\t");
        _builder_7.append("break;\t");
        ...
        _builder_7.append("}");
        _builder_7.newLine();
        fsa.generateFile(_buildFileName_6, _builder_7);
        EObject _head_1 = IterableExtensions.<EObject>head(resource.getContents());
        fsa.generateFile(this.buildFileName("PipesGraph"), this.generate(((Config) _head_1)));
      }
    }
  }
  ...
  public CharSequence generate(final Config config) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class PipesGraph extends PipeStages{");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public PipesGraph() {");
    _builder.newLine();
    {
      ...
      for(final Instance instance : _instances) {
        ...
        String _name_3 = instance.getName();
        _builder.append(_name_3, "\t\t");
        _builder.append("\").setPipesGraph(this);\t\t\t");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
